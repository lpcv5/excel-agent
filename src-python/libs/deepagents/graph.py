...
from libs.deepagents.backends.protocol import BackendFactory, BackendProtocol
...
from libs.deepagents.middleware.patch_tool_calls import PatchToolCallsMiddleware
...
from libs.deepagents.middleware.summarization import (
    ...
    *,
    ...
    for spec in subagents or []:
        if "runnable" in spec:
            ...
            subagent_summarization_defaults = _compute_summarization_defaults(
                subagent_model
            )
